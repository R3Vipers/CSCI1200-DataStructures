...
void StudentTest(){
    ...
    std::cout << "M12 to be transposed: " << std::endl;
    std::cout << m12 << std::endl;
    ...
    std::cout << "M12 to be mutliplied by 2: " << std::endl;

    m12.multiply_by_coefficient(2.0);

    std::cout << m12 << std::endl;

    std::cout << "M12 to be subtracted by m13(1): " << std::endl;
    ...
    std::cout << "First column of M12: " << std::endl;

    double* r2 = NULL;
    r2 = m12.get_col(0);

    for(int i = 0; i < m12.num_rows(); i++) {
        std::cout<<r2[i]<<" ";
    }
    std::cout<<std::endl;
    ...
    std::cout << "M14 to be quartered: (corner case test 2x2 quarter)" << std::endl;
    ...
    std::cout << "ma2[3] to be quartered: (corner case test 1x1 quarter)" << std::endl;
    std::cout << ma2[3] << std::endl;
    ...
    std::cout << "ma2[0] to be transposed: (corner case test 1x1 transpose)" << std::endl;
...
void ExtraCreditTest(){
    ...
    std::cout << "m15 to be resized: (corner case test 1x1 to 5x5 resize)" << std::endl;
    ...
    std::cout << "m15 to be resized: (corner case test 10x10 to 1x1 resize)" << std::endl;
